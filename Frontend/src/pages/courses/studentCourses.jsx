                                ...
                                <div className="p-12">
                                    <div className="flex justify-between items-start mb-10">
                                        <motion.div layoutId={`ann_meta_${selectedId}`} className="flex items-center gap-4">
                                            ...
                                            <span className="text-sm font-medium text-gray-400 dark:text-slate-500">{selectedAnnouncement.date}</span>
                                        </motion.div>
                                    ...
                                    >
                                        <motion.p layoutId={`ann_preview_${selectedId}`} className="text-xl leading-relaxed text-gray-600 dark:text-slate-400 mb-6 font-medium">
