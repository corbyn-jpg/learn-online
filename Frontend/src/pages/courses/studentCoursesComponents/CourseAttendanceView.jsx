                ...
                <table className="w-full text-left">
                    <thead>
                        <tr className="bg-gray-50/50">
                            ...
                            <th className="px-6 py-3 text-[10px] font-black uppercase tracking-widest text-gray-400">Session Type</th>
                            <th className="px-6 py-3 text-[10px] font-black uppercase tracking-widest text-gray-400">Time</th>
                    ...
                    <tbody>
                        {ATTENDANCE_LOGS.map((log, i) => (
                            <tr key={i} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/30 transition-colors group">
                                <td className="px-6 py-3.5 text-sm font-bold text-gray-900">{log.date}</td>
                                <td className="px-6 py-3.5 text-sm text-gray-600">{log.type}</td>
                                <td className="px-6 py-3.5 text-sm text-gray-400">{log.time}</td>
