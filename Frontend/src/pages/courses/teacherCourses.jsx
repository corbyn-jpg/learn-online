...
// Placeholder grade rows shown in CourseGradesView until the Grades API is wired up.
// Shape: { id, name, weight, grade, status, date }
const GRADES_DATA = [
  {
    id: 1,
    name: "Project 1: Research & Discovery",
    weight: "20%",
    grade: "85%",
    status: "Graded",
    date: "Mar 12, 2026",
  ...
  {
    id: 2,
    name: "Project 2: Wireframes & Prototyping",
    weight: "30%",
    grade: "78%",
    status: "Graded",
    date: "Apr 05, 2026",
  ...
  {
    id: 4,
    name: "Final Case Study Delivery",
    weight: "40%",
    grade: "-",
    status: "Pending",
    date: "Expected June",
...
// scaleIn          – fades in while scaling up from 95 %
...
// CourseAnnouncementsView – teacher variant of the announcements panel.
...
// Metadata for each assignment category supported by the platform.
// Used to render type-selector cards in the drawer and coloured icons in rows.
const ASSIGNMENT_TYPES = [
  {
    ...
    bg: "bg-[#3C0078]/10",
    description:
      "File uploads, text entry, URLs, or media recordings submitted directly through the platform.",
  },
  {
    id: "quiz",
    label: "Quiz",
    ...
    bg: "bg-[#FF8731]/10",
    description:
      "Multiple choice, essay, and matching questions with automatic or manual grading.",
  },
  {
    id: "discussion",
    ...
    bg: "bg-[#14B8A6]/10",
    description:
      "Interactive forum where students earn grades through participation and responses.",
  },
  {
    id: "peer",
    label: "Peer Review",
    ...
    bg: "bg-[#F59E0B]/10",
    description:
      "Students assess each other's work; can be anonymous or reveal reviewer names.",
  },
  {
    id: "external",
    ...
    bg: "bg-[#6366F1]/10",
    description:
      "Integrates Turnitin, Google Assignments, Microsoft 365, and other outside platforms.",
  },
  {
    id: "ungraded",
    ...
    bg: "bg-[#64748B]/10",
    description:
      "In-class tasks, attendance, or reading assignments that don't require an online turn-in.",
  },
];

// Initial assignment group structure populated in CourseAssignmentsView state.
// Each group holds a name, a percentage weight, and an array of assignment objects.
// Shape: { id, name, weight, assignments: [{ id, title, type, points, ... }] }
const ASSIGNMENT_GROUPS_DATA = [
  {
    ...
    assignments: [
      {
        id: "a1",
        title: "Project 1: Research & Discovery",
        type: "online",
        points: 100,
      ...
      {
        id: "a2",
        title: "Project 2: Wireframes & Prototyping",
        type: "online",
        points: 150,
        gradeDisplay: "Points",
        dueDate: "2026-04-05",
        availableFrom: "2026-03-20",
        availableUntil: "2026-04-08",
        assignedTo: "Everyone",
        published: true,
        submissions: 19,
        totalStudents: 26,
  ...
  },
  {
    ...
    assignments: [
      {
        id: "a3",
        title: "Mid-Term Knowledge Check",
        type: "quiz",
        points: 50,
        gradeDisplay: "Percentage",
        dueDate: "2026-04-15",
      ...
      {
        id: "a4",
        title: "UX Principles Quick Quiz",
        type: "quiz",
        points: 30,
        gradeDisplay: "Points",
        dueDate: "2026-05-02",
        availableFrom: "2026-05-02",
        availableUntil: "2026-05-02",
        assignedTo: "Everyone",
        published: false,
        submissions: 0,
        totalStudents: 26,
  ...
  },
  {
    ...
    assignments: [
      {
        id: "a5",
        title: "Week 3: Accessible Design Forum",
        type: "discussion",
        points: 20,
        gradeDisplay: "Complete/Incomplete",
        dueDate: "2026-03-22",
        availableFrom: "2026-03-18",
        availableUntil: "2026-03-24",
        assignedTo: "Everyone",
        published: true,
        submissions: 24,
        totalStudents: 26,
  ...
  },
  {
    ...
    assignments: [
      {
        id: "a6",
        title: "Peer Review: Prototype Critique",
        type: "peer",
        points: 25,
        gradeDisplay: "Points",
        dueDate: "2026-04-20",
  ...
  },
  {
    ...
    assignments: [
      {
        id: "a7",
        title: "Final Case Study Delivery",
        type: "online",
        points: 200,
        gradeDisplay: "Percentage",
        dueDate: "2026-06-10",
        availableFrom: "2026-06-01",
        availableUntil: "2026-06-12",
        assignedTo: "Everyone",
        published: false,
        submissions: 0,
        totalStudents: 26,
...
// Dropdown option lists used inside CreateAssignmentDrawer.
const GRADE_DISPLAY_OPTIONS = [
  "Percentage",
  "Points",
  "Letter Grade",
  "Complete/Incomplete",
...
// AssignmentTypeIcon – renders the coloured icon badge for a given assignment type ID.
// Returns null if the type is not found in ASSIGNMENT_TYPES.
function AssignmentTypeIcon({ type, size = 18 }) {
  ...
  return (
    <span
      className={`inline-flex items-center justify-center w-8 h-8 rounded-xl ${found.bg}`}
      title={found.label}
    >
...
// CreateAssignmentDrawer – slide-in right-panel drawer for creating or editing assignments.
// Renders a form with fields for type, title, description, points, grade display,
// submission type, assignees, assignment group, and date range.
// Accepts initialData to pre-fill the form when editing an existing assignment.
// Calls onSave({ ...form, published }) with the payload on submit.
            ...
            <div className="grid grid-cols-3 gap-2">
              {ASSIGNMENT_TYPES.map((t) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`inline-flex items-center justify-center w-9 h-9 rounded-xl ${t.bg}`}
                    >
                      <Icon size={18} style={{ color: t.color }} />
                    </span>
                    <span
                      className={`text-[10px] font-bold leading-tight ${form.type === t.id ? "text-[#3C0078]" : "text-gray-500"}`}
                    >
                      {t.label}
                    </span>
                  </button>
...
// AssignmentGroupRow – collapsible section row representing one assignment group.
// The header pill shows the group name and its percentage weight; clicking the weight
// pill switches to an inline input so the teacher can adjust it in place.
// Expanded state reveals a list of assignment cards with publish toggle, edit, and
// delete actions. Collapse/expand is animated.
function AssignmentGroupRow({
  ...
  const [weightDraft, setWeightDraft] = React.useState(String(group.weight));

  const commitWeight = () => {
    const parsed = parseInt(weightDraft, 10);
    if (!isNaN(parsed) && parsed >= 0 && parsed <= 100) {
      onWeightChange(group.id, parsed);
    } else {
    ...
    <motion.div variants={slideUp} className="mb-6">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          {editingWeight ? (
            <div
              className="flex items-center gap-1 bg-white border-2 border-[#3C0078]/40 rounded-full px-3 py-1"
            ...
            >
              <input
                ...
                className="w-10 text-center text-[10px] font-black text-[#3C0078] bg-transparent outline-none"
              />
              <span className="text-[10px] font-black text-[#3C0078]">
                % of grade
              </span>
            </div>
          ) : (
            ...
            >
              ...
              <Edit2
                size={10}
                className="opacity-0 group-hover/weight:opacity-100 transition-opacity"
              />
            </button>
          )}
            ...
            {group.assignments.map((item) => {
              ...
              return (
                ...
                >
                  {/* Type icon */}
                  <span
                    className={`shrink-0 inline-flex items-center justify-center w-10 h-10 rounded-2xl ${typeInfo?.bg || "bg-gray-100"}`}
                  >
                    <Icon
                      size={18}
...
// CourseAssignmentsView – full assignment management panel for teachers.
// Displays summary stat pills, a filterable assignment-type overview grid,
// and all AssignmentGroupRows. Teachers can create new assignments via the
// CreateAssignmentDrawer, toggle publish state, edit, or delete individual items.
function CourseAssignmentsView({ subject }) {
  ...
  const publishedCount = groups.reduce(
    (sum, g) => sum + g.assignments.filter((a) => a.published).length,
    0,
  );
  ...
  const handleWeightChange = (groupId, newWeight) => {
    setGroups((prev) =>
      prev.map((g) => (g.id !== groupId ? g : { ...g, weight: newWeight })),
    );
  };
    ...
    >
      ...
      <motion.div variants={slideUp} className="grid grid-cols-4 gap-4 mb-10">
        {[
          ...
          {
            label: "Drafts",
            value: totalAssignments - publishedCount,
            accent: false,
          },
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          {ASSIGNMENT_TYPES.map((t) => {
            ...
            const count = groups.reduce(
              (sum, g) =>
                sum + g.assignments.filter((a) => a.type === t.id).length,
              0,
            );
            ...
            return (
              ...
              >
                <span
                  className={`inline-flex items-center justify-center w-10 h-10 rounded-2xl ${t.bg}`}
                >
      ...
      <motion.div
        variants={slideUp}
        className="mt-10 flex items-center gap-4 p-6 bg-[#3C0078]/5 rounded-[28px] border border-[#3C0078]/10"
      >
        <BookOpen size={22} className="text-[#3C0078] shrink-0" />
        <div>
          <p className="text-sm font-bold text-[#3C0078]">Student View</p>
          <p className="text-xs text-gray-500 mt-0.5">
            Use Student View to see exactly how published assignments appear to
            students before releasing a new brief.
          </p>
        </div>
...
// CourseAttendanceView – attendance analytics panel for teachers.
// Shows a ring chart (AttendanceChart), a per-session streak visualiser
// (AttendanceVisualizer), a weekly rate callout card, and a per-student
// attendance table. The "Take Attendance" button is a placeholder for
// the live marking flow.
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12 items-stretch">
        ...
        <motion.div variants={scaleIn} className="flex flex-col gap-6">
          <div className="bg-[#3C0078] rounded-[40px] p-8 text-white flex-1 relative overflow-hidden group">
            ...
            <span className="text-[10px] uppercase font-bold tracking-[0.2em] opacity-80 block mb-2">
              Weekly Rate
            </span>
                    ...
                    className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm ${
                      parseInt(student.attendance) > 85
                        ...
                        : parseInt(student.attendance) > 75
                          ...
                          : parseInt(student.attendance) > 65
...
// Placeholder student roster used in CourseGradesView and CourseAttendanceView
// until the Grades & Attendance APIs are connected.
// Shape: { id, name, email, attendance, avgGrade, status, avatar }
const STUDENT_GRADES_DATA = [
  {
    id: 1,
    name: "Alice Johnson",
    email: "alice.j@student.ac.za",
    attendance: "95%",
    avgGrade: "88%",
    status: "Good",
    avatar: "AJ",
...
// CourseGradesView – grade analytics panel for teachers.
...
// CourseModulesView – module content browser.
// Splits into a left panel (ModuleAccordion for topic navigation) and a right
// panel that renders a content detail card with a placeholder grey block for
// the module media area.
...
// CourseNotesView – rich-text note-taking panel powered by the Novel editor.
// The left sidebar lists notes for the active course fetched from the API;
// the right panel renders the selected note with an expandable Novel editor
// that supports headings, lists, quotes, code blocks, and inline formatting
// via a floating bubble menu. Notes are auto-saved on every editor update.
    ...
    <div className="flex-1 flex h-full overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          transition:
            "width 0.35s ease, padding 0.35s ease, border-right-width 0.35s ease, opacity 0.2s ease",
        }}
      >
            ...
            {notes.map((note) => (
              ...
              >
                <div className="min-w-0">
                  <div
                    className={`font-bold text-sm truncate ${!note.title ? "opacity-40" : ""}`}
                  >
                    {note.title || "New Note"}
                  </div>
                  <div
                    className={`text-xs mt-1 ${activeNote?.id === note.id ? "text-white/70" : "text-gray-400"}`}
                  >
      ...
      >
        {activeNote ? (
          <div
            ...
            style={{
              transition:
                "padding 0.3s ease, border-radius 0.3s ease, background-color 0.3s ease, box-shadow 0.3s ease, border-color 0.3s ease",
            }}
          >
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setNotes((prev) =>
                  prev.map((n) =>
                    n.id === activeNote.id ? { ...n, title: updatedTitle } : n,
                  ),
                );
              }}
              onBlur={async () => {
            ...
            />
            <div
              className="flex-1 relative novel-editor-wrapper"
              key={activeNote.id}
            >
              <EditorRoot>
                <EditorContent
                  initialContent={(() => {
                    try {
                      const parsed = activeNote.content
