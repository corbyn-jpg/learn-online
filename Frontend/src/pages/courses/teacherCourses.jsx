...
import { getCourseAnnouncements, createAnnouncement, deleteAnnouncement, markAnnouncementAsRead, markAllAnnouncementsAsRead } from "../../services/announcementService";
                        ...
                        {announcements.map((post) => (
                            ...
                            >
                                ...
                                <div className="flex flex-1 items-start gap-4 pl-2 min-w-0">
                                    {/* Bell icon with matching color theme */}
                                    <div 
                                    ...
                                    {/* Title, preview, and lecturer info */}
