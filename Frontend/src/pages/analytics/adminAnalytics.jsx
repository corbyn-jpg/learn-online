  ...
  useEffect(() => {
    ...
    async function fetchTeacherData() {
      try {
        ...
        const raw = await getTeacherCourses(selectedTeacherId);
        ...
        if (mounted) {
          setTeacherAssignments(results.flatMap(r => r.assignments));
          setTeacherSubmissions(results.flatMap(r => r.submissions));
          setTeacherGrades(results.flatMap(r => r.grades));
        }
      } catch (err) {
