  ...
  return (
    <section className="relative overflow-hidden rounded-[30px] bg-white/90 p-7 shadow-[0_24px_60px_rgba(15,23,42,0.12)] backdrop-blur-md dark:border dark:border-slate-700 dark:bg-slate-900/90">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="inline-flex items-center gap-2 rounded-full border border-[#3C0078]/30 bg-white/80 px-3 py-1 text-xs font-semibold text-[#3C0078] dark:border-[#9BE9EA]/30 dark:bg-slate-800 dark:text-[#9BE9EA]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className={`inline-flex min-h-[44px] items-center gap-2 rounded-2xl border px-4 py-2 font-semibold shadow-sm transition hover:-translate-y-0.5 ${
              editMode
                ? "border-[#3C0078] bg-[#3C0078]/10 text-[#3C0078] dark:border-[#9BE9EA] dark:bg-[#9BE9EA]/15 dark:text-[#9BE9EA]"
          ...
          <button
            ...
            className="inline-flex min-h-[44px] items-center gap-2 rounded-2xl bg-gradient-to-r from-[#3C0078] to-[#5b1ca7] px-4 py-2 font-semibold text-white shadow-[0_10px_24px_rgba(60,0,120,0.35)] transition hover:-translate-y-0.5 hover:brightness-105 dark:from-[#0f766e] dark:to-[#14b8a6] dark:shadow-[0_10px_24px_rgba(15,118,110,0.35)]"
          >
