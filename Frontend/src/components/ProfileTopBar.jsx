...
export default function ProfileTopBar({
  ...
  return (
    <section className="relative overflow-hidden rounded-[30px] bg-white/90 p-7 shadow-[0_24px_60px_rgba(15,23,42,0.12)] backdrop-blur-md">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="inline-flex items-center gap-2 rounded-full border border-[#3C0078]/15 bg-white/70 px-3 py-1 text-xs font-semibold text-[#3C0078]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            disabled={publicRoute}
            className="inline-flex min-h-[44px] items-center gap-2 rounded-2xl border border-slate-300 bg-white/90 px-4 py-2 font-semibold text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:bg-white"
          >
