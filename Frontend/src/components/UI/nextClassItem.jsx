...
export default function NextClassItem({ subject = "UX300", time = "09:00 - 13:00", room = "Room 101" }) {
  return (
    <div className="my-2 bg-white dark:bg-slate-700 rounded-lg w-full h-12 flex flex-row items-center space-x-2 transition-all duration-200 hover:scale-[1.02] hover:shadow-md hover:bg-[#FF8731]/5 dark:hover:bg-[#FF8731]/15">
      {/* Orange icon badge */}
